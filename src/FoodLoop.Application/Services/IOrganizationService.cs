...
public interface IOrganizationService
{
    ...
    Task<OrganizationDto> GetMyOrganizationAsync(Guid ownerId, CancellationToken cancellationToken = default);

    /// <summary>PATCH /organizations/me/location â€” step 2's location fields.</summary>
    Task<OrganizationDto> UpdateLocationAsync(Guid ownerId, UpdateOrganizationLocationRequest request, CancellationToken cancellationToken = default);
