...
namespace FoodLoop.Infrastructure.Migrations
{
    ...
    [Migration("20260818172651_AddDisputeImageAndStoreDeactivationPolicy")]
    partial class AddDisputeImageAndStoreDeactivationPolicy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodLoop.Domain.Entities.AiPricingRecommendation", b =>
                {
                    ...
                    b.Property<decimal?>("SnapshotOriginalPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("SnapshotProductStatus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("SnapshotQuantityAvailable")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodLoop.Domain.Entities.AiRiskAssessment", b =>
                {
                    ...
                    b.Property<bool>("IsPricingStaged")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FoodLoop.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Property<decimal>("CommissionWithdrawn")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
            ...
            modelBuilder.Entity("FoodLoop.Domain.Entities.ProductPricingEpisode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("IngestionCorrelationId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<double>("SellThroughRate")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ProductPricingEpisodes", (string)null);
                });
            ...
            modelBuilder.Entity("FoodLoop.Domain.Entities.SystemSettings", b =>
                {
                    ...
                    b.Property<int>("MaxExpiredReportsBeforeDeactivation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3);
            ...
            modelBuilder.Entity("FoodLoop.Domain.Entities.AiPricingRecommendation", b =>
                {
                    ...
                    b.HasOne("FoodLoop.Domain.Entities.AiRiskAssessment", "RiskAssessment")
                        .WithMany()
