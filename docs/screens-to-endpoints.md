...
| `moderation_queue_empty_state` | GET | `/admin/products/pending-ai` | Admin | Empty array response |
| `ai_pricing_recommendation_review` | PATCH | `/admin/products/{id}/approve` | Admin | Approves a pending product |
