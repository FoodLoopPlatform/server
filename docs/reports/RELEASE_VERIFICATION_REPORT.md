...
All 490 tests passed successfully without any failures or regressions:

```text
Passed!  - Failed:     0, Passed:    28, Skipped:     0, Total:    28, Duration: 57 ms - FoodLoop.Domain.Tests.dll (net10.0)
Passed!  - Failed:     0, Passed:    11, Skipped:     0, Total:    11, Duration: 141 ms - FoodLoop.Application.Tests.dll (net10.0)
Passed!  - Failed:     0, Passed:   451, Skipped:     0, Total:   451, Duration: 26 s - FoodLoop.Infrastructure.Tests.dll (net10.0)

Total Test Suite Status: 490 Passed, 0 Failed, 100% Success Rate.
```
